...
public class Musica {
    ...
    private Map<Integer, Faixa> faixas; // Dicionário que mapeia a tecla (1 a 4) para a sua respectiva Faixa
    ...
    public Musica(int id, String nome, String pasta) {
        ...
        faixas = new LinkedHashMap<>(); // Inicializa o mapa preservando a ordem das faixas (1 a 4)
    }
    ...
    public void carregarFaixas() {
        ...
        // número da tecla
        faixas.put(1, new Faixa("Bateria", "audio/" + pasta + "/faixa1.wav", 1));
        faixas.put(2, new Faixa("Baixo", "audio/" + pasta + "/faixa2.wav", 2));
        faixas.put(3, new Faixa("Guitarra", "audio/" + pasta + "/faixa3.wav", 3));
        faixas.put(4, new Faixa("Violão", "audio/" + pasta + "/faixa4.wav", 4));
